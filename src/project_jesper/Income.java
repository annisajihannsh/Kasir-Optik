...
public class Income extends javax.swing.JFrame {
    ...
    private void tampilData() {
        ...
        try {
            int no = 1;
            String sql = "SELECT CONCAT(YEAR(tanggal)) AS tahun, (MONTH(tanggal)) AS bulan, SUM(total) AS total_pendapatan FROM transaksi GROUP BY YEAR(tanggal),MONTH(tanggal)";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Tahun", "Bulan", "Total Pendapatan"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        tahun = jTable1.getValueAt(baris, 0).toString();
        bulan = jTable1.getValueAt(baris, 1).toString();
