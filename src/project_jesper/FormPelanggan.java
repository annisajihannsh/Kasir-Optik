...
public class FormPelanggan extends javax.swing.JFrame {
        ...
        private void kode_pelanggan()
    {
       try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            if (res.next()) {
                String notrans = res.getString("id_pelanggan").substring(1);
               ...
               jTextField1.setText("L" + Nol + AN);
            } else {
               jTextField1.setText("L0001");
            }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(bodyPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 828, Short.MAX_VALUE)
        );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String kode_pelanggan = jTable1.getValueAt(baris, 0).toString();
        jTextField1.setText(kode_pelanggan);
        String nama_pelanggan = jTable1.getValueAt(baris, 1).toString();
        jTextField2.setText(nama_pelanggan);
        String alamat_pelanggan = jTable1.getValueAt(baris, 2).toString();
        jTextField3.setText(alamat_pelanggan);
