 ...
 * @author D E L L
 */
public class FormLens extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "minus", "plus" }));
        ...
        setSize(new java.awt.Dimension(816, 554));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {
            String sql = "INSERT INTO lensa VALUES ('" + jTextField1.getText() + "','" +
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            String sql = "UPDATE lensa SET kode_lensa='" + jTextField1.getText() + "'," +
                    "jenis_lensa='" + jComboBox1.getSelectedItem() + "'," +
                    "ukuran='" + jTextField4.getText() + "'," +
                    "harga_lensa='" + jTextField2.getText() + "'," +
                    "stok_lensa='" + jTextField3.getText() + "' WHERE " +
                    "kode_lensa = '" + jTextField1.getText() + "'";
            java.sql.Connection conn = (Connection) Konfig.configDB();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        try {
            String sql = "DELETE from lensa WHERE kode_lensa='" + jTextField1.getText() + "'";
            java.sql.Connection conn = (Connection) Konfig.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String kode_lensa = jTable1.getValueAt(baris, 0).toString();
        jTextField1.setText(kode_lensa);
        String jenis_lensa = jTable1.getValueAt(baris, 1).toString();
        jComboBox1.setSelectedItem(jenis_lensa);
        String ukuran_lensa = jTable1.getValueAt(baris, 2).toString();
        jTextField4.setText(ukuran_lensa);
        String harga_lensa = jTable1.getValueAt(baris, 3).toString();
        jTextField2.setText(harga_lensa);
        String stok_lensa = jTable1.getValueAt(baris, 4).toString();
        jTextField3.setText(stok_lensa);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
