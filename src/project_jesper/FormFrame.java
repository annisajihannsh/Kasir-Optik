...
public class FormFrame extends javax.swing.JFrame {
    ...
    private void kode_frame()
    {
       try {
            String sql="select * from frame order by kode_frame desc";
            java.sql.Connection conn = (Connection) Konfig.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            if (res.next()) {
                String notrans = res.getString("kode_frame").substring(1);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {
            String sql = "INSERT INTO frame VALUES ('" + jTextField1.getText() + "','" +
                    jTextField2.getText() + "','" +
                    jTextField3.getText() + "','" +
                    jTextField4.getText() + "')";
            java.sql.Connection conn = (Connection) Konfig.configDB();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String kode_frame = jTable1.getValueAt(baris, 0).toString();
        jTextField1.setText(kode_frame);
        String merk_frame = jTable1.getValueAt(baris, 1).toString();
        jTextField2.setText(merk_frame);
        String harga_frame = jTable1.getValueAt(baris, 2).toString();
        jTextField3.setText(harga_frame);
        String stok_frame = jTable1.getValueAt(baris, 3).toString();
        jTextField4.setText(stok_frame);
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            String sql = "UPDATE frame SET kode_frame='" + jTextField1.getText() + "'," +
                    "merk_frame='" + jTextField2.getText() + "'," +
                    "harga_frame='" + jTextField3.getText() + "'," +
                    "stok_frame='" + jTextField4.getText() + "' WHERE " +
                    "kode_frame = '" + jTextField1.getText() + "'";
            java.sql.Connection conn = (Connection) Konfig.configDB();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        try {
            String sql = "DELETE from frame WHERE kode_frame='" + jTextField1.getText() + "'";
            java.sql.Connection conn = (Connection) Konfig.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
